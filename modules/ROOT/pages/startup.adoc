...
In addition I also want to thank https://blog.frantovo.cz/[František Kučera] for
using my research in his effort to bring Linux Support to the DJM-250MK2 and
correcting me in
https://blog.frantovo.cz/c/387/Pioneer%20DJ%20DJM-250MK2%20support%20in%20the%20Linux%20kernel[his
blogpost]. I'd also like to thank Ashley Skye for
https://github.com/Swiftb0y/CDJHidProtocol/pull/7[contributing the Rekordbox
vendor Device ID for the DJM-900NXS2] Also thanks to "finn" for providing me
their DJM-450 Rekordbox Device ID via PM. Thank you to
https://github.com/musicmindmachine[@musicmindmachine] for
https://github.com/Swiftb0y/CDJHidProtocol/issues/9[finding an issue in the
handshake procedure] and correcting me. Thank you to https://github.com/felucia2[felucia]
for contributing https://github.com/Swiftb0y/CDJHidProtocol/pull/11[CDJ-3000] and other Device IDs.
